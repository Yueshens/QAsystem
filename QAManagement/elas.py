...
##################插入函数##############
    def insert(self,myindex,myquestion,myaccuratequestion,myanswer,mylink,mysubject,myid,qfh1,qfh2,myquescount,myuserlike):###变量为我们的插入.参数为q,a,id,注意此处的id
        doc = {
            "question": myquestion ,
...
# s1是当前问题，s2是之前的问题
    ...
    def accuratesearch(self,myindex,s1):# 变量为用户的提问，返回值为
        ...
        # res = self.es.search(index=myindex, size=5, body=
        # {
        #     "query": {
        #         "term": {
        #             "accuratequestion.keyword": s1
